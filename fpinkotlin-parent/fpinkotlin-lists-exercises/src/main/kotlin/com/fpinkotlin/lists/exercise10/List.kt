...
sealed class List<out A> {
    ...
    fun length(): Int = foldLeft(0) { a -> {a+1} }
...
fun sum(list: List<Int>): Int = list.foldLeft(0) {acc -> {elem -> acc + elem}}

fun product(list: List<Double>): Double = list.foldLeft(1.0) {acc -> {elem -> acc * elem}}
